...
const contentClasses = cn(
  'z-50 min-w-[9rem] overflow-hidden rounded-xl border border-border bg-popover p-1.5',
  'text-popover-foreground shadow-xl shadow-black/[0.08] dark:shadow-black/40',
